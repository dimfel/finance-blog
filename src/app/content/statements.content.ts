...
export const statementsChapter: Chapter = {
  ...
  blocks: [
    ...
    {
      type: 'figure',
      image: 'img/income-statement-flow.svg',
      alt: 'Income statement waterfall diagram showing how Revenue flows down through COGS, Gross Profit, Operating Expenses, EBIT, interest and taxes, to Net Income and EPS',
      caption: 'Every income statement follows this same top-to-bottom flow. The example uses round numbers — real company statements can span thousands of line items, but the structure is identical.',
    },
    {
      type: 'p',
    ...
    {
      type: 'figure',
      image: 'img/balance-sheet-structure.svg',
      alt: 'Balance sheet structure diagram showing Assets on the left and Liabilities plus Shareholders Equity on the right, with both sides totalling the same amount',
      caption: 'The two columns must always balance — hence the name. Everything the company owns (assets) was funded by either borrowed money (liabilities) or the owners\' own money (equity).',
    },
    {
      type: 'note',
    ...
    {
      type: 'figure',
      image: 'img/cash-flow-structure.svg',
      alt: 'Cash flow statement with three columns: Operating Activities (teal), Investing Activities (amber), and Financing Activities (purple), with Free Cash Flow formula at the bottom',
      caption: 'The three sections tell three different stories: Operating shows the engine\'s output; Investing shows what was spent to maintain and grow the business; Financing shows how the company interacts with lenders and shareholders. FCF = Operating − Capex.',
    },
    {
      type: 'ul',
      items: [
    ...
    {
      type: 'figure',
      image: 'img/three-statements-connection.svg',
      alt: 'Diagram showing how the three financial statements link together: net income from the income statement flows into the balance sheet retained earnings and tops the cash flow statement; the cash flow closing balance matches the balance sheet cash line',
      caption: 'The three statements are not separate islands — they share numbers. If the links break (e.g. profit rises but operating cash falls), that is a warning worth investigating.',
    },
